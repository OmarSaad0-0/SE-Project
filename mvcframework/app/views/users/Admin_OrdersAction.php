...
foreach($data as $order){
   echo "<tr ><td>".$order->Id."</td><td>".$order->Ordered_By."</td><td>".$order->base_product."</td><td>".$order->Fabric."</td><td>".$order->Colour."</td><td>".$order->Printing."</td><td>".$order->Quantity."</td><td>".$order->additionalInfo."</td><td>".$order->deliveryTime."</td>
